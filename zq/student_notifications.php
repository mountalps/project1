...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="notification-title-student">
        <?php if ($resultfq->num_rows == 0 && $resultf->num_rows > 0 && $resultt->num_rows > 0) {?>
          <p>Here are your notifications:</p>
        <?php } else {?>
          <p>You do not have notification.</p>
        <?php }?>
      </div>
